    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">You can register a new employee here</p>
            </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">New Employee Form</h5>
            </div>
                ...
                <form action="{{ route('employees.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control date @error('hire_date') is-invalid @enderror"
                            name="hire_date" id="hire_date" value="{{ old('hire_date') }}">
                        @error('hire_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
